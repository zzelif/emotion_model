...
from model import build_hybrid_microexpression_model, build_finetuned_mobilenetv2
...
mob_history = train_model(mobilenet_model, mob_x_train_img, None, mob_y_train, mob_x_val_img, None, mob_y_val, batch_size, epochs,
                          save_path="models/finetuned_mobilenet_model.h5")
...
plot_training_history(
    histories=[history, mob_history],
    labels=['Hybrid Microexpression Model', 'Fine-Tuned MobileNetV2 Model'],
